...
export const Checkout = ({ voltar }: CheckoutProps) => {
  return (
    <ContainerCheckout>
        <h3>Entrega</h3>   
        <form >
        ...
        <div className="butone">
            <BotaoCArt  onClick={voltar}> Continuar com o pagamento</BotaoCArt>
            <BotaoCArt onClick={voltar}> Voltar para o carrinho</BotaoCArt>
        </div>
    </ContainerCheckout>
  )
}
